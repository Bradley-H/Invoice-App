...
// .svelte-kit/output/server/chunks/Button.svelte_svelte_type_style_lang-9ba7d0ca.js
...
async function getInvoices(path) {
...
var subscriber_queue2, globalStore, css$1, Card, css, Text;
var init_Button_svelte_svelte_type_style_lang_9ba7d0ca = __esm({
  ".svelte-kit/output/server/chunks/Button.svelte_svelte_type_style_lang-9ba7d0ca.js"() {
    init_shims();
    init_app_116a3a4c();
    subscriber_queue2 = [];
    ...
    Card = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `${!inv ? `<div class="${[
        escape2(null_to_empty($globalStore.theme)) + " svelte-1dwcrx1",
...
// .svelte-kit/output/server/chunks/Button-cef138a9.js
var css$12, FormField, css2, Button;
var init_Button_cef138a9 = __esm({
  ".svelte-kit/output/server/chunks/Button-cef138a9.js"() {
    init_shims();
    init_app_116a3a4c();
    init_Button_svelte_svelte_type_style_lang_9ba7d0ca();
    css$12 = {
      code: "div.svelte-kvz031.svelte-kvz031{width:100%}div.title.svelte-kvz031.svelte-kvz031{margin-bottom:0.7rem}div.svelte-kvz031 input.svelte-kvz031,div.svelte-kvz031 select.svelte-kvz031{padding:0.8rem;border-radius:5px;font-weight:bold;width:100%;height:3.5rem}div.svelte-kvz031 input.Dark.svelte-kvz031,div.svelte-kvz031 select.Dark.svelte-kvz031{background-color:#21243c;color:#fff}div.svelte-kvz031 input.Light.svelte-kvz031,div.svelte-kvz031 select.Light.svelte-kvz031{background-color:#b1b1d2;color:black}div.svelte-kvz031 input.svelte-kvz031:disabled,div.svelte-kvz031 select.svelte-kvz031:disabled{opacity:0.6}select.svelte-kvz031.svelte-kvz031{border:none;margin:0;font-size:1.1rem;height:3.5rem}input[type=number].svelte-kvz031.svelte-kvz031{appearance:textfield}",
      map: null
    };
    FormField = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$unsubscribe_globalStore();
      return `<div class="${["svelte-kvz031", title ? "title" : ""].join(" ").trim()}"><label ${disabled ? "disabled" : ""}${add_attribute("for", id, 0)}>${validate_component(Text, "Text").$$render($$result, { disabled, size: "p", title: true, text }, {}, {})}</label>
${form === "text" ? `<input ${disabled ? "disabled" : ""} class="${escape2(null_to_empty($globalStore.theme)) + " svelte-kvz031"}"${add_attribute("id", id, 0)} type="${"text"}"${add_attribute("placeholder", placeholder, 0)}${add_attribute("value", value, 0)}>` : `${form === "number" ? `<input ${disabled ? "disabled" : ""} class="${escape2(null_to_empty($globalStore.theme)) + " svelte-kvz031"}"${add_attribute("step", step, 0)}${add_attribute("id", id, 0)} type="${"number"}"${add_attribute("placeholder", placeholder, 0)}${add_attribute("value", value, 0)}>` : `${form === "date" ? `<input ${disabled ? "disabled" : ""}${add_attribute("id", id, 0)} type="${"date"}"${add_attribute("placeholder", placeholder, 0)} class="${"svelte-kvz031"}"${add_attribute("value", value, 0)}>` : `${form === "select" ? `<select class="${escape2(null_to_empty($globalStore.theme)) + " svelte-kvz031"}">${each(options2, (val) => `<option${add_attribute("value", val.value, 0)}>${escape2(val.text)}</option>`)}</select>` : ``}`}`}`}</div>`;
    });
    css2 = {
      code: "a.svelte-j2wr93.svelte-j2wr93,button.svelte-j2wr93.svelte-j2wr93{display:flex;justify-content:center;align-items:center;padding:0.5rem;font-weight:bold;min-width:5rem;font-size:0.875rem;min-height:2.5rem;max-height:5.5rem;cursor:pointer}a.primary.svelte-j2wr93.svelte-j2wr93,button.primary.svelte-j2wr93.svelte-j2wr93{background-color:#7C5DFAFF}a.secondary.svelte-j2wr93.svelte-j2wr93,button.secondary.svelte-j2wr93.svelte-j2wr93{background-color:#7078b2;color:white}a.accent.svelte-j2wr93.svelte-j2wr93,button.accent.svelte-j2wr93.svelte-j2wr93{background-color:#7e88C3}a.danger.svelte-j2wr93.svelte-j2wr93,button.danger.svelte-j2wr93.svelte-j2wr93{background-color:#ec5757}a.fluid.svelte-j2wr93.svelte-j2wr93,button.fluid.svelte-j2wr93.svelte-j2wr93{width:100% !important}a.svelte-j2wr93 i.svelte-j2wr93,button.svelte-j2wr93 i.svelte-j2wr93{margin-right:0.7rem;font-size:1.1rem}a.rounded.svelte-j2wr93.svelte-j2wr93,button.rounded.svelte-j2wr93.svelte-j2wr93{border-radius:17px}a.medium.svelte-j2wr93.svelte-j2wr93,button.medium.svelte-j2wr93.svelte-j2wr93{width:7rem}a.small.svelte-j2wr93.svelte-j2wr93,button.small.svelte-j2wr93.svelte-j2wr93{width:5rem}a.large.svelte-j2wr93.svelte-j2wr93,button.large.svelte-j2wr93.svelte-j2wr93{width:9rem}",
      map: null
    };
    Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `${!href ? `<button class="${[
        escape2(type) + " " + escape2(size) + " svelte-j2wr93",
        (rounded ? "rounded" : "") + " " + (fluid ? "fluid" : "")
      ].join(" ").trim()}"><i class="${"fas fa-" + escape2(icon) + " svelte-j2wr93"}"></i>${escape2(text)}</button>` : `<a class="${escape2(null_to_empty(type)) + " svelte-j2wr93"}"${add_attribute("href", href, 0)}><i class="${"fas fa-" + escape2(icon) + " svelte-j2wr93"}"></i>${escape2(text)}</a>`}`;
    });
  }
});

// .svelte-kit/output/server/chunks/BackButton-e4e8a70d.js
var css3, BackButton;
var init_BackButton_e4e8a70d = __esm({
  ".svelte-kit/output/server/chunks/BackButton-e4e8a70d.js"() {
    init_shims();
    init_app_116a3a4c();
    init_Button_svelte_svelte_type_style_lang_9ba7d0ca();
    ...
    BackButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.href === void 0 && $$bindings.href && href !== void 0)
        $$bindings.href(href);
      $$result.css.add(css3);
      return `${href ? `<a href="${"/"}" class="${"svelte-gp9t8m"}"><i class="${"fas fa-chevron-left svelte-gp9t8m"}"></i>${validate_component(Text, "Text").$$render($$result, { size: "h3", text: "Go back" }, {}, {})}</a>` : `<button class="${"svelte-gp9t8m"}"><i class="${"fas fa-chevron-left svelte-gp9t8m"}"></i>${validate_component(Text, "Text").$$render($$result, { size: "h3", text: "Go back" }, {}, {})}</button>`}`;
    });
  }
});

// .svelte-kit/output/server/chunks/__layout-a9068454.js
var layout_a9068454_exports = {};
__export(layout_a9068454_exports, {
  default: () => _layout
});
var css$3, Navigation, css$2, ItemList, css$13, InvoiceModal, css4, _layout;
var init_layout_a9068454 = __esm({
  ".svelte-kit/output/server/chunks/__layout-a9068454.js"() {
    init_shims();
    init_app_116a3a4c();
    init_Button_svelte_svelte_type_style_lang_9ba7d0ca();
    init_Button_cef138a9();
    init_BackButton_e4e8a70d();
    init_ssr();
    css$3 = {
    ...
    css$2 = {
      code: ".itemList.svelte-hhxhiw.svelte-hhxhiw{display:flex;margin-bottom:2rem;gap:10px}@media(min-width: 768px){.itemList.svelte-hhxhiw.svelte-hhxhiw{display:grid;grid-template-columns:0.7fr 1.5fr}}.itemList.svelte-hhxhiw .nameField.svelte-hhxhiw{display:grid;grid-template-columns:1fr}.attributes.svelte-hhxhiw.svelte-hhxhiw{display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:10px}@media(min-width: 768px){.attributes.svelte-hhxhiw.svelte-hhxhiw{grid-template-columns:0.8fr 0.8fr 1.5fr 1fr}}",
      map: null
    };
    ItemList = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      do {
        $$settled = true;
        $$rendered = `<div class="${"itemList svelte-hhxhiw"}"><div class="${"nameField svelte-hhxhiw"}">${validate_component(FormField, "FormField").$$render($$result, {
          title: true,
          id: "Name" + index,
          text: "Name",
          placeholder: "Item",
          value: $globalStore.currentInvoice[0].items[index].name
        }, {
          value: ($$value) => {
            $globalStore.currentInvoice[0].items[index].name = $$value;
            $$settled = false;
          }
        }, {})}</div>
    <div class="${"attributes svelte-hhxhiw"}">${validate_component(FormField, "FormField").$$render($$result, {
          title: true,
          id: "qty" + index,
          form: "number",
          text: "Qty",
          placeholder: "Qty",
          value: $globalStore.currentInvoice[0].items[index].quantity
        }, {
          value: ($$value) => {
            $globalStore.currentInvoice[0].items[index].quantity = $$value;
            $$settled = false;
          }
        }, {})}
        ${validate_component(FormField, "FormField").$$render($$result, {
          ...
          text: "Price",
          placeholder: "Price",
          value: $globalStore.currentInvoice[0].items[index].price
        }, {
          value: ($$value) => {
            $globalStore.currentInvoice[0].items[index].price = $$value;
            $$settled = false;
          }
        }, {})}
        ${validate_component(FormField, "FormField").$$render($$result, {
          title: true,
          value: "$" + ($globalStore.currentInvoice[0].items[index].total = numberWithCommas($globalStore.currentInvoice[0].items[index].quantity * $globalStore.currentInvoice[0].items[index].price)),
          id: "total" + index,
          disabled: true,
          text: "Total",
          placeholder: "Total"
    ...
    InvoiceModal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      do {
        ...
        $$rendered = `${$globalStore.modalStatus !== null ? `<div class="${"modal svelte-inxhcl"}">${validate_component(Card, "Card").$$render($$result, { modal: true }, {}, {
          default: () => `<form class="${"svelte-inxhcl"}"><div class="${"title svelte-inxhcl"}">${validate_component(Text, "Text").$$render($$result, { title: true, size: "h2", text: title }, {}, {})}
        ...
        <div class="${"billFrom svelte-inxhcl"}"><p class="${"svelte-inxhcl"}">Bill From</p>    
            <div class="${"billFrom_information svelte-inxhcl"}">${validate_component(FormField, "FormField").$$render($$result, {
            title: true,
            text: "Street Address",
            id: "senderStreet",
            placeholder: "Street Address",
            value: $globalStore.currentInvoice[0].senderAddress.street
          }, {
            value: ($$value) => {
              $globalStore.currentInvoice[0].senderAddress.street = $$value;
              $$settled = false;
            }
          }, {})}
                <div class="${"billFrom_information-city svelte-inxhcl"}">${validate_component(FormField, "FormField").$$render($$result, {
            title: true,
            text: "City",
            id: "senderCity",
            placeholder: "City",
            value: $globalStore.currentInvoice[0].senderAddress.city
          }, {
            value: ($$value) => {
              $globalStore.currentInvoice[0].senderAddress.city = $$value;
              $$settled = false;
            }
          }, {})}
                    ${validate_component(FormField, "FormField").$$render($$result, {
            ...
            value: $globalStore.currentInvoice[0].senderAddress.postCode
          }, {
            value: ($$value) => {
              $globalStore.currentInvoice[0].senderAddress.postCode = $$value;
              $$settled = false;
            }
          }, {})}
                    <div class="${"billFrom_information-country svelte-inxhcl"}">${validate_component(FormField, "FormField").$$render($$result, {
            title: true,
            id: "senderCountry",
            text: "Country",
            placeholder: "Country",
            value: $globalStore.currentInvoice[0].senderAddress.country
          }, {
            value: ($$value) => {
              $globalStore.currentInvoice[0].senderAddress.country = $$value;
              $$settled = false;
            }
          }, {})}</div></div></div></div>
    ...
    <div class="${"billTo svelte-inxhcl"}"><p class="${"svelte-inxhcl"}">Bill To</p>
        ${validate_component(FormField, "FormField").$$render($$result, {
            ...
            id: "clientName",
            placeholder: "Name",
            value: $globalStore.currentInvoice[0].clientName
          }, {
            value: ($$value) => {
              $globalStore.currentInvoice[0].clientName = $$value;
              $$settled = false;
            }
          }, {})}
        ${validate_component(FormField, "FormField").$$render($$result, {
            ...
            id: "clientEmail",
            placeholder: "Email",
            value: $globalStore.currentInvoice[0].clientEmail
          }, {
            value: ($$value) => {
              $globalStore.currentInvoice[0].clientEmail = $$value;
              $$settled = false;
            }
          }, {})}
        ${validate_component(FormField, "FormField").$$render($$result, {
            ...
            id: "clientStreet",
            placeholder: "Street Address",
            value: $globalStore.currentInvoice[0].clientAddress.street
          }, {
            value: ($$value) => {
              $globalStore.currentInvoice[0].clientAddress.street = $$value;
              $$settled = false;
            }
          }, {})}

        <div class="${"billTo_information svelte-inxhcl"}"><div class="${"billTo_information-city svelte-inxhcl"}">${validate_component(FormField, "FormField").$$render($$result, {
            text: "City",
            id: "clientCity",
            placeholder: "City",
            value: $globalStore.currentInvoice[0].clientAddress.city
          }, {
            value: ($$value) => {
              $globalStore.currentInvoice[0].clientAddress.city = $$value;
              $$settled = false;
            }
          }, {})}
                ${validate_component(FormField, "FormField").$$render($$result, {
            ...
            id: "clientPostCode",
            placeholder: "Postal code",
            value: $globalStore.currentInvoice[0].clientAddress.postCode
          }, {
            value: ($$value) => {
              $globalStore.currentInvoice[0].clientAddress.postCode = $$value;
              $$settled = false;
            }
          }, {})}
                <div class="${"billTo_information-country svelte-inxhcl"}">${validate_component(FormField, "FormField").$$render($$result, {
            id: "clientCountry",
            text: "Country",
            placeholder: "Country",
            value: $globalStore.currentInvoice[0].clientAddress.country
          }, {
            value: ($$value) => {
              $globalStore.currentInvoice[0].clientAddress.country = $$value;
              $$settled = false;
            }
          }, {})}</div></div></div>

        <div class="${"billTo_invoiceInformation svelte-inxhcl"}">${validate_component(FormField, "FormField").$$render($$result, {
            text: "Invoice Date",
            id: "paymentDue",
            disabled: true,
            value: $globalStore.currentInvoice[0].paymentDue
          }, {
            value: ($$value) => {
              $globalStore.currentInvoice[0].paymentDue = $$value;
              $$settled = false;
            }
          }, {})}
            ${validate_component(FormField, "FormField").$$render($$result, {
            ...
            value: $globalStore.currentInvoice[0].paymentTerms
          }, {
            value: ($$value) => {
              $globalStore.currentInvoice[0].paymentTerms = $$value;
              $$settled = false;
            }
          }, {})}</div>
        ${validate_component(FormField, "FormField").$$render($$result, {
            ...
            value: $globalStore.currentInvoice[0].description
          }, {
            value: ($$value) => {
              $globalStore.currentInvoice[0].description = $$value;
              $$settled = false;
            }
          }, {})}</div>

    <p class="${"svelte-inxhcl"}">Item list</p>
    <div class="${"items svelte-inxhcl"}">${each($globalStore.currentInvoice[0].items, (_, i2) => `${validate_component(ItemList, "ItemList").$$render($$result, { index: i2 }, {}, {})}`)}
    ...
    <div class="${"btns svelte-inxhcl"}">${validate_component(Button, "Button").$$render($$result, {
            type: "danger",
            icon: "trash",
            size: "medium",
            rounded: true,
        ...
        <div class="${"svelte-inxhcl"}">${validate_component(Button, "Button").$$render($$result, {
            type: "secondary",
            icon: "save",
            size: "medium",
            rounded: true,
...
<main class="${"bgColor" + escape2(theme) + " svelte-1q82shh"}">${slots.default ? slots.default({}) : ``}</main>`;
    });
  }
});

// .svelte-kit/output/server/chunks/error-c8e48a74.js
var error_c8e48a74_exports = {};
__export(error_c8e48a74_exports, {
  default: () => Error2,
  load: () => load
});
...
// .svelte-kit/output/server/chunks/Tag-83b8c714.js
var css5, Tag;
var init_Tag_83b8c714 = __esm({
  ".svelte-kit/output/server/chunks/Tag-83b8c714.js"() {
    init_shims();
    init_app_116a3a4c();
    init_Button_svelte_svelte_type_style_lang_9ba7d0ca();
    ...
    Tag = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.status === void 0 && $$bindings.status && status !== void 0)
        $$bindings.status(status);
      $$result.css.add(css5);
      return `<div class="${escape2(null_to_empty(status)) + " svelte-6d8z8o"}"><h3 class="${escape2(null_to_empty(status)) + " svelte-6d8z8o"}">${escape2(status)}</h3></div>`;
    });
  }
});

// .svelte-kit/output/server/chunks/index-b34207dd.js
var index_b34207dd_exports = {};
__export(index_b34207dd_exports, {
  default: () => Routes
});
var css$14, Invoice, css6, Routes;
var init_index_b34207dd = __esm({
  ".svelte-kit/output/server/chunks/index-b34207dd.js"() {
    init_shims();
    init_app_116a3a4c();
    init_Button_cef138a9();
    ...
    Invoice = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `${validate_component(Card, "Card").$$render($$result, { inv: true, id }, {}, {
        default: () => `<div class="${"container-invoice svelte-1qgxoo4"}"><div class="${"dueInformation svelte-1qgxoo4"}">${validate_component(Text, "Text").$$render($$result, { size: "h3", text: "#" + id }, {}, {})}
            <div class="${"svelte-1qgxoo4"}">${validate_component(Text, "Text").$$render($$result, {
          size: "p",
    ...
    <div class="${"paymentInformation svelte-1qgxoo4"}">${validate_component(Text, "Text").$$render($$result, { size: "p", text: clientName }, {}, {})}
      ...
      do {
        ...
        $$rendered = `<div class="${"container svelte-4nkv9z"}">${function(__value) {
          if (is_promise(__value)) {
            ...
            return `
    <div class="${"loading svelte-4nkv9z"}">${validate_component(Text, "Text").$$render($$result, {
              size: "h1",
    ...
    `;
          ...
          return function(inv) {
            return ` 
    <div class="${"helperBar svelte-4nkv9z"}"><div class="${"helperBar_invoice svelte-4nkv9z"}">${validate_component(Text, "Text").$$render($$result, { size: "h2", text: "Invoices" }, {}, {})}
            ${validate_component(Text, "Text").$$render($$result, {
              size: "p",
              text: inv.filter((invoice) => invoice.status == filter || filter === "all").length + " invoices"
            }, {}, {})}</div>
        <div class="${"settings svelte-4nkv9z"}">${validate_component(FormField, "FormField").$$render($$result, {
              id: "filter",
              form: "select",
              options: options2,
              value: filter
    ...
    <div class="${"invoices svelte-4nkv9z"}">${each(inv, ({ id, paymentDue, total, clientName, status }, i2) => `${filter == "all" || status == filter ? `<div>${validate_component(Invoice, "Invoice").$$render($$result, {
              id,
              paymentDue,
              total,
              clientName,
...
// .svelte-kit/output/server/chunks/_invoice_-cd6ea151.js
var invoice_cd6ea151_exports = {};
__export(invoice_cd6ea151_exports, {
  default: () => U5Binvoiceu5D
});
var getStores, page, css$15, InnerCard, css7, InvoiceInformation, U5Binvoiceu5D;
var init_invoice_cd6ea151 = __esm({
  ".svelte-kit/output/server/chunks/_invoice_-cd6ea151.js"() {
    init_shims();
    init_app_116a3a4c();
    init_Button_svelte_svelte_type_style_lang_9ba7d0ca();
    ...
    InnerCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $globalStore, $$unsubscribe_globalStore;
      $$unsubscribe_globalStore = subscribe(globalStore, (value) => $globalStore = value);
      $$result.css.add(css$15);
      $$unsubscribe_globalStore();
      return `<div class="${escape2(null_to_empty($globalStore.theme)) + " svelte-1utl24k"}">${slots.default ? slots.default({}) : ``}</div>`;
    });
    css7 = {
    ...
    InvoiceInformation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $$unsubscribe_globalStore;
...
<div class="${"invoiceContainer svelte-hyhlu6"}"><div class="${"backButton svelte-hyhlu6"}">${validate_component(BackButton, "BackButton").$$render($$result, { href: true }, {}, {})}</div>

    <div class="${"topCard svelte-hyhlu6"}">${validate_component(Card, "Card").$$render($$result, { round: true }, {}, {
        default: () => `<div class="${"topCard_invoiceStatus svelte-hyhlu6"}">${validate_component(Text, "Text").$$render($$result, { size: "p", text: "Status:" }, {}, {})}
    ...
    <div class="${"bottomCard svelte-hyhlu6"}">${validate_component(Card, "Card").$$render($$result, { round: true }, {}, {
        default: () => `<div class="${"bottomCard_invoiceInfo svelte-hyhlu6"}"><div class="${"bottomCard_invoiceInfo-details svelte-hyhlu6"}"><div class="${"bottomCard_invoiceInfo-ID svelte-hyhlu6"}">${validate_component(Text, "Text").$$render($$result, { size: "h3", text: "#" + id }, {}, {})}
                        ${validate_component(Text, "Text").$$render($$result, { size: "p", text: description }, {}, {})}</div> 
    
                    <div class="${"bottomCard_invoiceInfo-senderInfo svelte-hyhlu6"}">${validate_component(Text, "Text").$$render($$result, { size: "p", text: senderAddress }, {}, {})}
                        ${validate_component(Text, "Text").$$render($$result, { size: "p", text: senderCity }, {}, {})}
                        ${validate_component(Text, "Text").$$render($$result, { size: "p", text: senderPostCode }, {}, {})}
                        ${validate_component(Text, "Text").$$render($$result, { size: "p", text: senderCountry }, {}, {})}</div></div>
            
                

                <div class="${"bottomCard_invoiceInfo-billTo svelte-hyhlu6"}"><div class="${"bottomCard_invoiceInfo-billTo-invoices svelte-hyhlu6"}"><div class="${"bottomCard_invoiceInfo-billTo-invoiceDate svelte-hyhlu6"}">${validate_component(Text, "Text").$$render($$result, { size: "p", text: "Invoice Date" }, {}, {})}
                            ${validate_component(Text, "Text").$$render($$result, { size: "h3", text: formateDate(createdAt) }, {}, {})}</div>
    
                        <div class="${"bottomCard_invoiceInfo-billTo-invoiceDue svelte-hyhlu6"}">${validate_component(Text, "Text").$$render($$result, { size: "p", text: "Payment Due" }, {}, {})}
                            ${validate_component(Text, "Text").$$render($$result, {
          size: "h3",
          text: formateDate(paymentDue)
        }, {}, {})}</div></div>

                    <div class="${"bottomCard_invoiceInfo-billTo-client svelte-hyhlu6"}">${validate_component(Text, "Text").$$render($$result, { size: "p", text: "Bill To" }, {}, {})}
                        <div>${validate_component(Text, "Text").$$render($$result, { size: "h3", text: clientName }, {}, {})}</div>
                        <div class="${"bottomCard_invoiceInfo-billTo-client-information svelte-hyhlu6"}">${validate_component(Text, "Text").$$render($$result, { size: "p", text: clientAddress }, {}, {})}
                            ${validate_component(Text, "Text").$$render($$result, { size: "p", text: clientCity }, {}, {})}
                            ${validate_component(Text, "Text").$$render($$result, { size: "p", text: clientPostCode }, {}, {})}
                            ${validate_component(Text, "Text").$$render($$result, { size: "p", text: clientCountry }, {}, {})}</div></div>
                
                    <div class="${"bottomCard_invoiceInfo-billTo-email svelte-hyhlu6"}">${validate_component(Text, "Text").$$render($$result, { size: "p", text: "Sent to" }, {}, {})}
                        ${validate_component(Text, "Text").$$render($$result, { size: "h3", text: clientEmail }, {}, {})}</div></div>

                <div class="${"bottomCard_invoiceInfo-itemList svelte-hyhlu6"}">${validate_component(InnerCard, "InnerCard").$$render($$result, {}, {}, {
          default: () => `${each(items, (item, i2) => `<div class="${"bottomCard_invoiceInfo-itemList-items svelte-hyhlu6"}"><div class="${"bottomCard_invoiceInfo-itemList-items-description"}">${validate_component(Text, "Text").$$render($$result, { size: "h3", text: item.itemName }, {}, {})}
                                    ${validate_component(Text, "Text").$$render($$result, {
            size: "p",
            text: "$" + numberWithCommas(item.itemPrice.toFixed(2)) + " x " + item.itemQuantity + " "
          }, {}, {})}</div>
                                ${validate_component(Text, "Text").$$render($$result, {
            size: "h3",
            text: "$" + numberWithCommas((item.itemQuantity * item.itemPrice).toFixed(2))
          }, {}, {})}
                            </div>`)}`
        })}
                    <div class="${"bottomCard_invoiceInfo-itemList-items-total svelte-hyhlu6"}"><h3 class="${"svelte-hyhlu6"}">Amount Due</h3>
                        <h3 class="${"svelte-hyhlu6"}">$${escape2(numberWithCommas(total.toFixed(2)))}</h3></div></div></div>`
      })}</div></div>
...
${function(__value) {
        if (is_promise(__value)) {
          __value.then(null, noop3);
          return `
    <div class="${"loader"}">${validate_component(Text, "Text").$$render($$result, {
            size: "h2",
  ...
  ${validate_component(InvoiceInformation, "InvoiceInformation").$$render($$result, Object.assign(inv), {}, {})}
    `;
      ...
      }(getInvoices($page.path.slice(1)))}`;
    });
  }
});

// .svelte-kit/output/server/chunks/app-116a3a4c.js
function noop3() {
}
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-393a8fdb.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-393a8fdb.js", assets + "/_app/chunks/vendor-9e1d27ee.js"]
    },
    fetched: void 0,
    floc: false,
...
var current_component, escaped2, missing_component, on_destroy, css8, Root, base, assets, user_hooks, template, options, default_settings, d, empty, manifest, get_hooks, module_lookup, metadata_lookup;
var init_app_116a3a4c = __esm({
  ".svelte-kit/output/server/chunks/app-116a3a4c.js"() {
    init_shims();
    init_ssr();
    Promise.resolve();
...
${``}`;
    ...
    module_lookup = {
      "src/routes/__layout.svelte": () => Promise.resolve().then(() => (init_layout_a9068454(), layout_a9068454_exports)),
      ".svelte-kit/build/components/error.svelte": () => Promise.resolve().then(() => (init_error_c8e48a74(), error_c8e48a74_exports)),
      "src/routes/index.svelte": () => Promise.resolve().then(() => (init_index_b34207dd(), index_b34207dd_exports)),
      "src/routes/[invoice].svelte": () => Promise.resolve().then(() => (init_invoice_cd6ea151(), invoice_cd6ea151_exports))
    };
    metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-706e9687.js", "css": ["assets/pages/__layout.svelte-edad1902.css", "assets/Button-a57f7956.css", "assets/FormField-eac69818.css", "assets/BackButton-06655f75.css"], "js": ["pages/__layout.svelte-706e9687.js", "chunks/vendor-9e1d27ee.js", "chunks/Button-9d57e2b6.js", "chunks/FormField-12674371.js", "chunks/BackButton-e7c887af.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-285171c9.js", "css": [], "js": ["error.svelte-285171c9.js", "chunks/vendor-9e1d27ee.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-2efa8780.js", "css": ["assets/pages/index.svelte-70f8904e.css", "assets/Button-a57f7956.css", "assets/Tag-69ba6e74.css", "assets/FormField-eac69818.css"], "js": ["pages/index.svelte-2efa8780.js", "chunks/vendor-9e1d27ee.js", "chunks/Button-9d57e2b6.js", "chunks/Tag-887165b6.js", "chunks/FormField-12674371.js"], "styles": [] }, "src/routes/[invoice].svelte": { "entry": "pages/_invoice_.svelte-20b19c1b.js", "css": ["assets/pages/_invoice_.svelte-ef943170.css", "assets/Button-a57f7956.css", "assets/BackButton-06655f75.css", "assets/Tag-69ba6e74.css"], "js": ["pages/_invoice_.svelte-20b19c1b.js", "chunks/vendor-9e1d27ee.js", "chunks/Button-9d57e2b6.js", "chunks/BackButton-e7c887af.js", "chunks/Tag-887165b6.js"], "styles": [] } };
  }
});
