...
const Tag = (0, import_index_b6406b22.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${(0, import_index_b6406b22.e)((0, import_index_b6406b22.h)(status), true) + " svelte-17lhqxy"}"><h3 class="${(0, import_index_b6406b22.e)($globalStore.theme, true) + " " + (0, import_index_b6406b22.e)(status, true) + " svelte-17lhqxy"}">${(0, import_index_b6406b22.e)(status)}</h3></div>`;
});
