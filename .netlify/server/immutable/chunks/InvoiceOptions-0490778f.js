import { c as create_ssr_component, a as subscribe, j as add_attribute, v as validate_component, e as escape, h as null_to_empty, f as each } from "./index-b6406b22.js";
import { g as globalStore, T as Text } from "./functionStore-d6f5ac9b.js";
...
${form === "text" ? `<input ${disabled ? "disabled" : ""} class="${[
    escape(null_to_empty(theme), true) + " svelte-1b38cb9",
