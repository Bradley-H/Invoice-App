...
const FormField = (0, import_index_80978f94.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_globalStore = (0, import_index_80978f94.a)(import_functionStore_c189635e.g, (value2) => $globalStore = value2);
  let { form = "text" } = $$props;
  ...
  return `<div class="${["svelte-1b38cb9", title ? "title" : ""].join(" ").trim()}"><label ${disabled ? "disabled" : ""}${(0, import_index_80978f94.h)("for", id, 0)}>${(0, import_index_80978f94.v)(import_functionStore_c189635e.T, "Text").$$render($$result, { disabled, size: "p", title: true, text }, {}, {})}</label>
