...
const FormField = (0, import_index_6b830c0a.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_globalStore = (0, import_index_6b830c0a.a)(import_functionStore_495b3dd7.g, (value2) => $globalStore = value2);
  let { form = "text" } = $$props;
  ...
  return `<div class="${["svelte-1b38cb9", title ? "title" : ""].join(" ").trim()}"><label ${disabled ? "disabled" : ""}${(0, import_index_6b830c0a.h)("for", id, 0)}>${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { disabled, size: "p", title: true, text }, {}, {})}</label>
