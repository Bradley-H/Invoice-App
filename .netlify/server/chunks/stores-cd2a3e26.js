...
const BackButton = (0, import_index_e78bd06d.c)(($$result, $$props, $$bindings, slots) => {
  let { href = false } = $$props;
  if ($$props.href === void 0 && $$bindings.href && href !== void 0)
    $$bindings.href(href);
  $$result.css.add(css$1);
  return `${href ? `<a href="${"/"}" class="${"svelte-mjdnc8"}"><i class="${"fas fa-chevron-left svelte-mjdnc8"}"></i>${(0, import_index_e78bd06d.v)(import_functionStore_1bfb3d3a.T, "Text").$$render($$result, { size: "h3", text: "Go back" }, {}, {})}</a>` : `<button class="${"svelte-mjdnc8"}"><i class="${"fas fa-chevron-left svelte-mjdnc8"}"></i>${(0, import_index_e78bd06d.v)(import_functionStore_1bfb3d3a.T, "Text").$$render($$result, { size: "h3", text: "Go back" }, {}, {})}</button>`}`;
});
...
const InnerCard = (0, import_index_e78bd06d.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${[
    (0, import_index_e78bd06d.e)((0, import_index_e78bd06d.h)($globalStore.theme), true) + " svelte-buor3",
    modal ? "modal" : ""
  ].join(" ").trim()}">${slots.default ? slots.default({}) : ``}</div>`;
});
var ModalPrompt_svelte_svelte_type_style_lang = "";
const getStores = () => {
  const stores = (0, import_index_e78bd06d.k)("__svelte__");
  return {
    page: {
