...
const BackButton = (0, import_index_6b830c0a.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `${href ? `<a href="${"/"}" class="${"svelte-1l6v9yg"}"><i class="${"fas fa-chevron-left svelte-1l6v9yg"}"></i>${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "h3", text: "Go back" }, {}, {})}</a>` : `<button class="${"svelte-1l6v9yg"}"><i class="${"fas fa-chevron-left svelte-1l6v9yg"}"></i>${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "h3", text: "Go back" }, {}, {})}</button>`}`;
});
...
const InnerCard = (0, import_index_6b830c0a.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${[
    (0, import_index_6b830c0a.e)((0, import_index_6b830c0a.g)($globalStore.theme)) + " svelte-buor3",
    modal ? "modal" : ""
