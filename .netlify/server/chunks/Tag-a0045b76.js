import { c as create_ssr_component, a as subscribe, e as escape, h as null_to_empty } from "./index-d2589f30.js";
import { g as globalStore } from "./functionStore-31d719cc.js";
...
const Tag = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${escape(null_to_empty(status)) + " svelte-17lhqxy"}"><h3 class="${escape($globalStore.theme) + " " + escape(status) + " svelte-17lhqxy"}">${escape(status)}</h3></div>`;
});
export { Tag as T };
