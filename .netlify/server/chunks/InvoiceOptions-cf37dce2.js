...
var import_functionStore_1bfb3d3a = require("./functionStore-1bfb3d3a.js");
...
const FormField = (0, import_index_e78bd06d.c)(($$result, $$props, $$bindings, slots) => {
  let theme;
  let $globalStore, $$unsubscribe_globalStore;
  $$unsubscribe_globalStore = (0, import_index_e78bd06d.a)(import_functionStore_1bfb3d3a.g, (value2) => $globalStore = value2);
  let { form = "text" } = $$props;
  ...
  return `<div class="${["svelte-1b38cb9", title ? "title" : ""].join(" ").trim()}"><label ${disabled ? "disabled" : ""}${(0, import_index_e78bd06d.j)("for", id, 0)}>${(0, import_index_e78bd06d.v)(import_functionStore_1bfb3d3a.T, "Text").$$render($$result, { disabled, size: "p", title: true, text }, {}, {})}</label>
${form === "text" ? `<input ${disabled ? "disabled" : ""} class="${[
    (0, import_index_e78bd06d.e)((0, import_index_e78bd06d.h)(theme), true) + " svelte-1b38cb9",
    !valid && touched ? "invalid" : ""
  ].join(" ").trim()}"${(0, import_index_e78bd06d.j)("id", id, 0)} type="${"text"}"${(0, import_index_e78bd06d.j)("placeholder", placeholder, 0)}${(0, import_index_e78bd06d.j)("value", value, 0)}>` : `${form === "number" ? `<input ${disabled ? "disabled" : ""} class="${[
    (0, import_index_e78bd06d.e)((0, import_index_e78bd06d.h)(theme), true) + " svelte-1b38cb9",
    !valid && touched ? "invalid" : ""
  ].join(" ").trim()}"${(0, import_index_e78bd06d.j)("id", id, 0)} type="${"number"}"${(0, import_index_e78bd06d.j)("placeholder", placeholder, 0)}${(0, import_index_e78bd06d.j)("value", value, 0)}>` : `${form === "date" ? `<input ${disabled ? "disabled" : ""}${(0, import_index_e78bd06d.j)("id", id, 0)} type="${"date"}"${(0, import_index_e78bd06d.j)("placeholder", placeholder, 0)} class="${["svelte-1b38cb9", !valid ? "invalid" : ""].join(" ").trim()}"${(0, import_index_e78bd06d.j)("value", value, 0)}>` : `${form === "select" ? `<select class="${(0, import_index_e78bd06d.e)((0, import_index_e78bd06d.h)(theme), true) + " svelte-1b38cb9"}">${(0, import_index_e78bd06d.f)(options2, (val) => {
    return `<option${(0, import_index_e78bd06d.j)("value", val.value, 0)}>${(0, import_index_e78bd06d.e)(val.text)}</option>`;
  })}</select>` : ``}`}`}`}
${invalidMessage && !valid && touched ? `<p class="${["svelte-1b38cb9", !valid ? "invalid" : ""].join(" ").trim()}">${(0, import_index_e78bd06d.e)(invalidMessage)}</p>` : ``}</div>`;
});
const options = [
