...
const Tag = (0, import_index_e78bd06d.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${(0, import_index_e78bd06d.e)((0, import_index_e78bd06d.h)(status), true) + " svelte-17lhqxy"}"><h3 class="${(0, import_index_e78bd06d.e)($globalStore.theme, true) + " " + (0, import_index_e78bd06d.e)(status, true) + " svelte-17lhqxy"}">${(0, import_index_e78bd06d.e)(status)}</h3></div>`;
});
