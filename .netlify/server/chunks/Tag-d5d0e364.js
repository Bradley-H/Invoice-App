...
const Tag = (0, import_index_3930c651.c)(($$result, $$props, $$bindings, slots) => {
  let { status } = $$props;
  if ($$props.status === void 0 && $$bindings.status && status !== void 0)
    $$bindings.status(status);
  $$result.css.add(css);
  return `<div class="${(0, import_index_3930c651.e)((0, import_index_3930c651.f)(status)) + " svelte-6d8z8o"}"><h3 class="${(0, import_index_3930c651.e)((0, import_index_3930c651.f)(status)) + " svelte-6d8z8o"}">${(0, import_index_3930c651.e)(status)}</h3></div>`;
});
