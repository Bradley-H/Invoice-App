...
const InvoiceInformation = (0, import_index_b6406b22.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page = (0, import_index_b6406b22.a)(import_stores_491b1fed.p, (value) => value);
  let { status = "" } = $$props;
  let { id = "" } = $$props;
  ...
  $$unsubscribe_page();
  return `<div class="${"invoiceContainer svelte-lrrse9"}"><div class="${"backButton svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_stores_491b1fed.B, "BackButton").$$render($$result, { href: true }, {}, {})}</div>

    <div class="${"topCard svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.C, "Card").$$render($$result, { round: true }, {}, {
    default: () => {
      return `<div class="${"topCard_invoiceStatus svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "p", text: "Status:" }, {}, {})}
                ${(0, import_index_b6406b22.v)(import_Tag_247b288a.T, "Tag").$$render($$result, { status }, {}, {})}</div>
                <div class="${"topCard_buttons svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.B, "Button").$$render($$result, {
        size: "large",
        text: "Edit",
        type: "secondary",
        icon: "pen",
    ...
    <div class="${"bottomCard svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.C, "Card").$$render($$result, { round: true }, {}, {
    default: () => {
      return `<div class="${"bottomCard_invoiceInfo svelte-lrrse9"}"><div class="${"bottomCard_invoiceInfo-details svelte-lrrse9"}"><div class="${"bottomCard_invoiceInfo-ID svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "h3", text: "#" + id }, {}, {})}
                        ${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "p", text: description }, {}, {})}</div>

                    <div class="${"bottomCard_invoiceInfo-senderInfo svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "p", text: senderAddress.street }, {}, {})}
                        ${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "p", text: senderAddress.city }, {}, {})}
                        ${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "p", text: senderAddress.postCode }, {}, {})}
                        ${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "p", text: senderAddress.country }, {}, {})}</div></div>

                <div class="${"bottomCard_invoiceInfo-billTo svelte-lrrse9"}"><div class="${"bottomCard_invoiceInfo-billTo-invoices svelte-lrrse9"}"><div class="${"bottomCard_invoiceInfo-billTo-invoiceDate svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "p", text: "Invoice Date" }, {}, {})}
                            ${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, {
        size: "h3",
        text: (0, import_functionStore_d6f5ac9b.c)(createdAt, 0)
      }, {}, {})}</div>

                        <div class="${"bottomCard_invoiceInfo-billTo-invoiceDue svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "p", text: "Payment Due" }, {}, {})}
                            ${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, {
        size: "h3",
        text: (0, import_functionStore_d6f5ac9b.c)(paymentDue, 0)
      }, {}, {})}</div></div>

                    <div class="${"bottomCard_invoiceInfo-billTo-client svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "p", text: "Bill To" }, {}, {})}
                        <div>${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "h3", text: clientName }, {}, {})}</div>
                        <div class="${"bottomCard_invoiceInfo-billTo-client-information svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "p", text: clientAddress.street }, {}, {})}
                            ${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "p", text: clientAddress.city }, {}, {})}
                            ${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "p", text: clientAddress.postCode }, {}, {})}
                            ${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "p", text: clientAddress.country }, {}, {})}</div></div>

                    <div class="${"bottomCard_invoiceInfo-billTo-email svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "p", text: "Sent to" }, {}, {})}
                        ${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "h3", text: clientEmail }, {}, {})}</div></div>

                <div class="${"bottomCard_invoiceInfo-itemList svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_stores_491b1fed.I, "InnerCard").$$render($$result, {}, {}, {
        default: () => {
          return `${(0, import_index_b6406b22.f)(items, (item, i) => {
            return `<div class="${"bottomCard_invoiceInfo-itemList-items svelte-lrrse9"}"><div class="${"bottomCard_invoiceInfo-itemList-items-description svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "h3", text: item.name }, {}, {})}
                                    ${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, {
              size: "p",
              text: "$" + Number(items[i].price).toFixed(2) + " x " + items[i].quantity
                                ...
                                ${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, {
              size: "h3",
              text: "$" + (0, import_functionStore_d6f5ac9b.n)((item.quantity * item.price).toFixed(2))
            }, {}, {})}
                            </div>`;
          })}`;
        }
                    ...
                    <div class="${"bottomCard_invoiceInfo-itemList-items-total svelte-lrrse9"}"><h3 class="${"svelte-lrrse9"}">Amount Due</h3>
                        <h3 class="${"svelte-lrrse9"}">$${(0, import_index_b6406b22.e)((0, import_functionStore_d6f5ac9b.n)(total.toFixed(2)))}</h3></div></div></div>`;
    }
  })}</div></div>

<div class="${"bottomCard_buttons svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.C, "Card").$$render($$result, {}, {}, {
    default: () => {
      return `<div class="${"btns svelte-lrrse9"}">${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.B, "Button").$$render($$result, {
        size: "medium",
        fluid: true,
        text: "Edit",
        type: "secondary",
...
const U5Binvoiceu5D = (0, import_index_b6406b22.c)(($$result, $$props, $$bindings, slots) => {
  ...
  async function getInvoiceInformation(path) {
    await (0, import_functionStore_d6f5ac9b.b)();
  ...
  return `${function(__value) {
    if ((0, import_index_b6406b22.l)(__value)) {
      ...
      return `
    <div class="${"loader svelte-1v7wm0g"}">${(0, import_index_b6406b22.v)(import_functionStore_d6f5ac9b.T, "Text").$$render($$result, { size: "h2", text: msg }, {}, {})}</div>
`;
    }
    return function(inv) {
      return `
    ${(0, import_index_b6406b22.v)(InvoiceInformation, "InvoiceInformation").$$render($$result, Object.assign(inv), {}, {})}
`;
    }(__value);
