...
var import_functionStore_aea32d8f = __toModule(require("../../chunks/functionStore-aea32d8f.js"));
var import_stores_cb49be3a = __toModule(require("../../chunks/stores-cb49be3a.js"));
var import_Tag_0004dd66 = __toModule(require("../../chunks/Tag-0004dd66.js"));
...
const InvoiceInformation = (0, import_index_6b830c0a.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_globalStore = (0, import_index_6b830c0a.a)(import_functionStore_aea32d8f.g, (value) => value);
  $$unsubscribe_page = (0, import_index_6b830c0a.a)(import_stores_cb49be3a.p, (value) => value);
  let { status } = $$props;
  let { id } = $$props;
...
<div class="${"invoiceContainer svelte-nx3yyw"}"><div class="${"backButton svelte-nx3yyw"}">${(0, import_index_6b830c0a.v)(import_stores_cb49be3a.B, "BackButton").$$render($$result, { href: true }, {}, {})}</div>

    <div class="${"topCard svelte-nx3yyw"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.C, "Card").$$render($$result, { round: true }, {}, {
    default: () => `<div class="${"topCard_invoiceStatus svelte-nx3yyw"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "p", text: "Status:" }, {}, {})}
                ${(0, import_index_6b830c0a.v)(import_Tag_0004dd66.T, "Tag").$$render($$result, { status }, {}, {})}</div>
            ${``}`
  })}</div>



    <div class="${"bottomCard svelte-nx3yyw"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.C, "Card").$$render($$result, { round: true }, {}, {
    default: () => `<div class="${"bottomCard_invoiceInfo svelte-nx3yyw"}"><div class="${"bottomCard_invoiceInfo-details svelte-nx3yyw"}"><div class="${"bottomCard_invoiceInfo-ID svelte-nx3yyw"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "h3", text: "#" + id }, {}, {})}
                        ${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "p", text: description }, {}, {})}</div> 
    
                    <div class="${"bottomCard_invoiceInfo-senderInfo svelte-nx3yyw"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "p", text: senderAddress.street }, {}, {})}
                        ${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "p", text: senderAddress.city }, {}, {})}
                        ${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "p", text: senderAddress.postCode }, {}, {})}
                        ${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "p", text: senderAddress.country }, {}, {})}</div></div>
            
                

                <div class="${"bottomCard_invoiceInfo-billTo svelte-nx3yyw"}"><div class="${"bottomCard_invoiceInfo-billTo-invoices svelte-nx3yyw"}"><div class="${"bottomCard_invoiceInfo-billTo-invoiceDate svelte-nx3yyw"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "p", text: "Invoice Date" }, {}, {})}
                            ${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, {
      size: "h3",
      text: (0, import_functionStore_aea32d8f.c)(createdAt, 0)
    }, {}, {})}</div>
    
                        <div class="${"bottomCard_invoiceInfo-billTo-invoiceDue svelte-nx3yyw"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "p", text: "Payment Due" }, {}, {})}
                            ${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, {
      size: "h3",
      text: (0, import_functionStore_aea32d8f.c)(paymentDue, 0)
    }, {}, {})}</div></div>

                    <div class="${"bottomCard_invoiceInfo-billTo-client svelte-nx3yyw"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "p", text: "Bill To" }, {}, {})}
                        <div>${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "h3", text: clientName }, {}, {})}</div>
                        <div class="${"bottomCard_invoiceInfo-billTo-client-information svelte-nx3yyw"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "p", text: clientAddress.street }, {}, {})}
                            ${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "p", text: clientAddress.city }, {}, {})}
                            ${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "p", text: clientAddress.postCode }, {}, {})}
                            ${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "p", text: clientAddress.country }, {}, {})}</div></div>
                
                    <div class="${"bottomCard_invoiceInfo-billTo-email svelte-nx3yyw"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "p", text: "Sent to" }, {}, {})}
                        ${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "h3", text: clientEmail }, {}, {})}</div></div>

                <div class="${"bottomCard_invoiceInfo-itemList svelte-nx3yyw"}">${(0, import_index_6b830c0a.v)(import_stores_cb49be3a.I, "InnerCard").$$render($$result, {}, {}, {
      default: () => `${(0, import_index_6b830c0a.d)(items, (item, i) => `<div class="${"bottomCard_invoiceInfo-itemList-items svelte-nx3yyw"}"><div class="${"bottomCard_invoiceInfo-itemList-items-description"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "h3", text: item.name }, {}, {})}
                                    ${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, {
        size: "p",
        text: "$" + (0, import_functionStore_aea32d8f.n)(item.price.toFixed(2)) + " x " + item.quantity + " "
      }, {}, {})}</div>
                                ${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, {
        size: "h3",
        text: "$" + (0, import_functionStore_aea32d8f.n)((item.quantity * item.price).toFixed(2))
      }, {}, {})}
                            </div>`)}`
    })}
                    <div class="${"bottomCard_invoiceInfo-itemList-items-total svelte-nx3yyw"}"><h3 class="${"svelte-nx3yyw"}">Amount Due</h3>
                        <h3 class="${"svelte-nx3yyw"}">$${(0, import_index_6b830c0a.e)((0, import_functionStore_aea32d8f.n)(total.toFixed(2)))}</h3></div></div></div>`
  })}</div></div>
...
const U5Binvoiceu5D = (0, import_index_6b830c0a.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page = (0, import_index_6b830c0a.a)(import_stores_cb49be3a.p, (value) => $page = value);
  async function getInvoiceInformation(path) {
    await (0, import_functionStore_aea32d8f.a)();
...
${function(__value) {
    if ((0, import_index_6b830c0a.j)(__value)) {
      ...
      return `
    <div class="${"loader svelte-15x83bc"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, {
        size: "h2",
