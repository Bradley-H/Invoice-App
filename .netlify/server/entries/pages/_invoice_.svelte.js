...
<div class="${"invoiceContainer svelte-1m31m9p"}"><div class="${"backButton svelte-1m31m9p"}">${(0, import_index_80978f94.v)(import_stores_5de73f26.B, "BackButton").$$render($$result, { href: true }, {}, {})}</div>

    <div class="${"topCard svelte-1m31m9p"}">${(0, import_index_80978f94.v)(import_functionStore_abc42331.C, "Card").$$render($$result, { round: true }, {}, {
    default: () => {
      return `<div class="${"topCard_invoiceStatus svelte-1m31m9p"}">${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "p", text: "Status:" }, {}, {})}
                ${(0, import_index_80978f94.v)(import_Tag_4abda796.T, "Tag").$$render($$result, { status }, {}, {})}</div>
            ${``}`;
    }
  })}</div>
    ...
    <div class="${"bottomCard svelte-1m31m9p"}">${(0, import_index_80978f94.v)(import_functionStore_abc42331.C, "Card").$$render($$result, { round: true }, {}, {
    default: () => {
      return `<div class="${"bottomCard_invoiceInfo svelte-1m31m9p"}"><div class="${"bottomCard_invoiceInfo-details svelte-1m31m9p"}"><div class="${"bottomCard_invoiceInfo-ID svelte-1m31m9p"}">${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "h3", text: "#" + id }, {}, {})}
                        ${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "p", text: description }, {}, {})}</div> 
    
                    <div class="${"bottomCard_invoiceInfo-senderInfo svelte-1m31m9p"}">${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "p", text: senderAddress.street }, {}, {})}
                        ${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "p", text: senderAddress.city }, {}, {})}
                        ${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "p", text: senderAddress.postCode }, {}, {})}
                        ${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "p", text: senderAddress.country }, {}, {})}</div></div>
            
                

                <div class="${"bottomCard_invoiceInfo-billTo svelte-1m31m9p"}"><div class="${"bottomCard_invoiceInfo-billTo-invoices svelte-1m31m9p"}"><div class="${"bottomCard_invoiceInfo-billTo-invoiceDate svelte-1m31m9p"}">${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "p", text: "Invoice Date" }, {}, {})}
                            ${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, {
        size: "h3",
        text: (0, import_functionStore_abc42331.c)(createdAt, 0)
      }, {}, {})}</div>
    
                        <div class="${"bottomCard_invoiceInfo-billTo-invoiceDue svelte-1m31m9p"}">${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "p", text: "Payment Due" }, {}, {})}
                            ${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, {
        size: "h3",
        text: (0, import_functionStore_abc42331.c)(paymentDue, 0)
      }, {}, {})}</div></div>

                    <div class="${"bottomCard_invoiceInfo-billTo-client svelte-1m31m9p"}">${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "p", text: "Bill To" }, {}, {})}
                        <div>${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "h3", text: clientName }, {}, {})}</div>
                        <div class="${"bottomCard_invoiceInfo-billTo-client-information svelte-1m31m9p"}">${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "p", text: clientAddress.street }, {}, {})}
                            ${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "p", text: clientAddress.city }, {}, {})}
                            ${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "p", text: clientAddress.postCode }, {}, {})}
                            ${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "p", text: clientAddress.country }, {}, {})}</div></div>
                
                    <div class="${"bottomCard_invoiceInfo-billTo-email svelte-1m31m9p"}">${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "p", text: "Sent to" }, {}, {})}
                        ${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "h3", text: clientEmail }, {}, {})}</div></div>

                <div class="${"bottomCard_invoiceInfo-itemList svelte-1m31m9p"}">${(0, import_index_80978f94.v)(import_stores_5de73f26.I, "InnerCard").$$render($$result, {}, {}, {
        default: () => {
          return `${(0, import_index_80978f94.d)(items, (item, i) => {
            return `<div class="${"bottomCard_invoiceInfo-itemList-items svelte-1m31m9p"}"><div class="${"bottomCard_invoiceInfo-itemList-items-description svelte-1m31m9p"}">${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "h3", text: item.name }, {}, {})}
                                    ${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, {
              size: "p",
              text: "$" + Number(items[i].price).toFixed(2) + " x " + items[i].quantity
                                ...
                                ${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, {
              size: "h3",
              text: "$" + (0, import_functionStore_abc42331.n)((item.quantity * item.price).toFixed(2))
            }, {}, {})}
                            </div>`;
          })}`;
        }
                    ...
                    <div class="${"bottomCard_invoiceInfo-itemList-items-total svelte-1m31m9p"}"><h3 class="${"svelte-1m31m9p"}">Amount Due</h3>
                        <h3 class="${"svelte-1m31m9p"}">$${(0, import_index_80978f94.e)((0, import_functionStore_abc42331.n)(total.toFixed(2)))}</h3></div></div></div>`;
    }
  })}</div></div>
...
const U5Binvoiceu5D = (0, import_index_80978f94.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page = (0, import_index_80978f94.a)(import_stores_5de73f26.p, (value) => $page = value);
  async function getInvoiceInformation(path) {
    await (0, import_functionStore_abc42331.a)();
...
${function(__value) {
    if ((0, import_index_80978f94.j)(__value)) {
      ...
      return `
    <div class="${"loader svelte-1v7wm0g"}">${(0, import_index_80978f94.v)(import_functionStore_abc42331.T, "Text").$$render($$result, { size: "h2", text: msg }, {}, {})}</div>
    `;
    }
    return function(inv) {
      return `
