...
<div class="${"invoiceContainer svelte-1m31m9p"}"><div class="${"backButton svelte-1m31m9p"}">${(0, import_index_6b830c0a.v)(import_stores_2b8a15c5.B, "BackButton").$$render($$result, { href: true }, {}, {})}</div>

    <div class="${"topCard svelte-1m31m9p"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.C, "Card").$$render($$result, { round: true }, {}, {
    default: () => `<div class="${"topCard_invoiceStatus svelte-1m31m9p"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "p", text: "Status:" }, {}, {})}
    ...
    <div class="${"bottomCard svelte-1m31m9p"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.C, "Card").$$render($$result, { round: true }, {}, {
    default: () => `<div class="${"bottomCard_invoiceInfo svelte-1m31m9p"}"><div class="${"bottomCard_invoiceInfo-details svelte-1m31m9p"}"><div class="${"bottomCard_invoiceInfo-ID svelte-1m31m9p"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "h3", text: "#" + id }, {}, {})}
                        ${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "p", text: description }, {}, {})}</div> 
    
                    <div class="${"bottomCard_invoiceInfo-senderInfo svelte-1m31m9p"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "p", text: senderAddress.street }, {}, {})}
                ...
                <div class="${"bottomCard_invoiceInfo-billTo svelte-1m31m9p"}"><div class="${"bottomCard_invoiceInfo-billTo-invoices svelte-1m31m9p"}"><div class="${"bottomCard_invoiceInfo-billTo-invoiceDate svelte-1m31m9p"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "p", text: "Invoice Date" }, {}, {})}
      ...
      text: (0, import_functionStore_495b3dd7.c)(createdAt, 0)
                        ...
                        <div class="${"bottomCard_invoiceInfo-billTo-invoiceDue svelte-1m31m9p"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "p", text: "Payment Due" }, {}, {})}
                            ${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, {
      size: "h3",
      text: (0, import_functionStore_495b3dd7.c)(paymentDue, 0)
    }, {}, {})}</div></div>

                    <div class="${"bottomCard_invoiceInfo-billTo-client svelte-1m31m9p"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "p", text: "Bill To" }, {}, {})}
                        <div>${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "h3", text: clientName }, {}, {})}</div>
                        <div class="${"bottomCard_invoiceInfo-billTo-client-information svelte-1m31m9p"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "p", text: clientAddress.street }, {}, {})}
                    ...
                    <div class="${"bottomCard_invoiceInfo-billTo-email svelte-1m31m9p"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "p", text: "Sent to" }, {}, {})}
                        ${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "h3", text: clientEmail }, {}, {})}</div></div>

                <div class="${"bottomCard_invoiceInfo-itemList svelte-1m31m9p"}">${(0, import_index_6b830c0a.v)(import_stores_2b8a15c5.I, "InnerCard").$$render($$result, {}, {}, {
      default: () => `${(0, import_index_6b830c0a.d)(items, (item, i) => `<div class="${"bottomCard_invoiceInfo-itemList-items svelte-1m31m9p"}"><div class="${"bottomCard_invoiceInfo-itemList-items-description svelte-1m31m9p"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "h3", text: item.name }, {}, {})}
                                    ${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, {
        size: "p",
        ...
        text: "$" + (0, import_functionStore_495b3dd7.n)((item.quantity * item.price).toFixed(2))
                    ...
                    <div class="${"bottomCard_invoiceInfo-itemList-items-total svelte-1m31m9p"}"><h3 class="${"svelte-1m31m9p"}">Amount Due</h3>
                        <h3 class="${"svelte-1m31m9p"}">$${(0, import_index_6b830c0a.e)((0, import_functionStore_495b3dd7.n)(total.toFixed(2)))}</h3></div></div></div>`
  })}</div></div>
...
${function(__value) {
    if ((0, import_index_6b830c0a.j)(__value)) {
      ...
      return `
    <div class="${"loader svelte-1v7wm0g"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "h2", text: msg }, {}, {})}</div>
    `;
    }
    return function(inv) {
      return `
