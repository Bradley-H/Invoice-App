...
const Navigation = (0, import_index_3930c651.c)(($$result, $$props, $$bindings, slots) => {
  let $$unsubscribe_globalStore;
  $$unsubscribe_globalStore = (0, import_index_3930c651.a)(import_functionStore_b30ced0b.g, (value) => value);
  let icon = "moon";
  $$result.css.add(css$2);
  $$unsubscribe_globalStore();
  return `<nav class="${"svelte-cy09dy"}"><a href="${"/"}" class="${"svelte-cy09dy"}"><i class="${"fas fa-home svelte-cy09dy"}"></i></a>
    <div class="${"settings svelte-cy09dy"}"><div class="${"themeSwitcher svelte-cy09dy"}"><i class="${"fas fa-" + (0, import_index_3930c651.e)(icon) + " svelte-cy09dy"}"></i></div>
...
const InvoiceModal = (0, import_index_3930c651.c)(($$result, $$props, $$bindings, slots) => {
  let title;
  let newInvoice;
  let isValid;
  let senderAddress;
  ...
  do {
    ...
    isValid = false;
    $$rendered = `${$globalStore.modalStatus !== null ? `<div class="${"modal svelte-1eyjac7"}">${(0, import_index_3930c651.v)(import_functionStore_b30ced0b.C, "Card").$$render($$result, { modal: true }, {}, {
      default: () => `<form class="${"svelte-1eyjac7"}"><div class="${"title svelte-1eyjac7"}">${(0, import_index_3930c651.v)(import_functionStore_b30ced0b.T, "Text").$$render($$result, { title: true, size: "h2", text: title }, {}, {})}
        ${(0, import_index_3930c651.v)(import_BackButton_56ddd62b.B, "BackButton").$$render($$result, {}, {}, {})}</div>

        <div class="${"billFrom svelte-1eyjac7"}"><p class="${"svelte-1eyjac7"}">Bill From</p>    
            <div class="${"billFrom_information svelte-1eyjac7"}">${(0, import_index_3930c651.v)(import_Button_15a9fb03.F, "FormField").$$render($$result, {
        title: true,
        text: "Street Address",
        id: "senderStreet",
        ...
        value: ($$value) => {
          ...
          $$settled = false;
                ...
                <div class="${"billFrom_information-city svelte-1eyjac7"}">${(0, import_index_3930c651.v)(import_Button_15a9fb03.F, "FormField").$$render($$result, {
        title: true,
        text: "City",
        id: "senderCity",
        placeholder: "City",
        ...
        value: ($$value) => {
          ...
          $$settled = false;
                    ...
                    ${(0, import_index_3930c651.v)(import_Button_15a9fb03.F, "FormField").$$render($$result, {
        title: true,
        text: "Postal Code",
        id: "senderPostCode",
        ...
        value: ($$value) => {
          ...
          $$settled = false;
                    ...
                    <div class="${"billFrom_information-country svelte-1eyjac7"}">${(0, import_index_3930c651.v)(import_Button_15a9fb03.F, "FormField").$$render($$result, {
        title: true,
        id: "senderCountry",
        text: "Country",
        placeholder: "Country",
    ...
    <div class="${"billTo svelte-1eyjac7"}"><p class="${"svelte-1eyjac7"}">Bill To</p>
        ...
        <div class="${"billTo_information svelte-1eyjac7"}"><div class="${"billTo_information-city svelte-1eyjac7"}">${(0, import_index_3930c651.v)(import_Button_15a9fb03.F, "FormField").$$render($$result, {
        text: "City",
        id: "clientCity",
        placeholder: "City",
        ...
        value: ($$value) => {
          ...
          $$settled = false;
                ...
                <div class="${"billTo_information-country svelte-1eyjac7"}">${(0, import_index_3930c651.v)(import_Button_15a9fb03.F, "FormField").$$render($$result, {
        id: "clientCountry",
        text: "Country",
        placeholder: "Country",
        ...
        <div class="${"billTo_invoiceInformation svelte-1eyjac7"}">${(0, import_index_3930c651.v)(import_Button_15a9fb03.F, "FormField").$$render($$result, {
        text: "Invoice Date",
        id: "paymentDue",
        disabled: true,
        value: (0, import_functionStore_b30ced0b.c)(Date(), paymentTerms),
        valid: true
      }, {}, {})}
            ${(0, import_index_3930c651.v)(import_Button_15a9fb03.F, "FormField").$$render($$result, {
        form: "select",
    ...
    <div class="${"items svelte-1eyjac7"}">${(0, import_index_3930c651.b)(items, (item, i) => `<div class="${"itemList svelte-1eyjac7"}"><div class="${"nameField svelte-1eyjac7"}">${(0, import_index_3930c651.v)(import_Button_15a9fb03.F, "FormField").$$render($$result, {
        title: true,
        id: "Name" + i,
        text: "Name",
        placeholder: "Item",
        ...
        value: ($$value) => {
          ...
          $$settled = false;
                ...
                <div class="${"attributes svelte-1eyjac7"}">${(0, import_index_3930c651.v)(import_Button_15a9fb03.F, "FormField").$$render($$result, {
        title: true,
        id: "qty" + i,
        form: "number",
        text: "Qty",
        ...
        value: ($$value) => {
          ...
          $$settled = false;
                    ...
                    ${(0, import_index_3930c651.v)(import_Button_15a9fb03.F, "FormField").$$render($$result, {
        title: true,
        value: "$" + (0, import_functionStore_b30ced0b.n)(item.quantity * item.price),
        valid: true,
        id: "total" + i,
        disabled: true,
        text: "Total",
    ...
    <div class="${"btns svelte-1eyjac7"}">${(0, import_index_3930c651.v)(import_Button_15a9fb03.B, "Button").$$render($$result, {
        type: "danger",
        icon: "trash",
        size: "medium",
        rounded: true,
        ...
        <div class="${"svelte-1eyjac7"}">${(0, import_index_3930c651.v)(import_Button_15a9fb03.B, "Button").$$render($$result, {
        type: "secondary",
        icon: "save",
        size: "medium",
        disabled: !isValid,
...
const _layout = (0, import_index_3930c651.c)(($$result, $$props, $$bindings, slots) => {
  let theme;
  let $globalStore, $$unsubscribe_globalStore;
  $$unsubscribe_globalStore = (0, import_index_3930c651.a)(import_functionStore_b30ced0b.g, (value) => $globalStore = value);
  $$result.css.add(css);
  ...
  $$unsubscribe_globalStore();
  return `${(0, import_index_3930c651.v)(Navigation, "Navigation").$$render($$result, {}, {}, {})}
${(0, import_index_3930c651.v)(InvoiceModal, "InvoiceModal").$$render($$result, {}, {}, {})}
<main class="${"bgColor" + (0, import_index_3930c651.e)(theme) + " svelte-1q82shh"}">${slots.default ? slots.default({}) : ``}</main>`;
});
