...
const Navigation = (0, import_index_80978f94.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="${"svelte-bj8hib"}"><a href="${"/"}" class="${"svelte-bj8hib"}"><i class="${"fas fa-home svelte-bj8hib"}"></i></a>
    <div class="${"settings svelte-bj8hib"}"><div class="${"themeSwitcher svelte-bj8hib"}"><i class="${"fas fa-" + (0, import_index_80978f94.e)(icon) + " svelte-bj8hib"}"></i></div>
        <div class="${"avatar svelte-bj8hib"}"><i class="${"fas fa-user-circle svelte-bj8hib"}"></i></div></div></nav>`;
});
const css$3 = {
