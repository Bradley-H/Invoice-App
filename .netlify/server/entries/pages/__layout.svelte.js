...
const Navigation = (0, import_index_d2589f30.c)(($$result, $$props, $$bindings, slots) => {
...
const ModalPrompt = (0, import_index_d2589f30.c)(($$result, $$props, $$bindings, slots) => {
  (0, import_index_d2589f30.b)();
  let { text = "" } = $$props;
  if ($$props.text === void 0 && $$bindings.text && text !== void 0)
    $$bindings.text(text);
  $$result.css.add(css$2);
  return `<div class="${"prompt svelte-1vb4462"}">${(0, import_index_d2589f30.v)(import_stores_7cb77692.I, "InnerCard").$$render($$result, { modal: true }, {}, {
    default: () => {
      return `${(0, import_index_d2589f30.v)(import_functionStore_31d719cc.T, "Text").$$render($$result, { size: "h3", text }, {}, {})}
       <div class="${"btns svelte-1vb4462"}">${(0, import_index_d2589f30.v)(import_functionStore_31d719cc.B, "Button").$$render($$result, { type: "secondary", text: "Yes" }, {}, {})}
           ${(0, import_index_d2589f30.v)(import_functionStore_31d719cc.B, "Button").$$render($$result, { type: "danger", text: "No" }, {}, {})}</div>`;
    }
  })}</div>
...
const InvoiceModal = (0, import_index_d2589f30.c)(($$result, $$props, $$bindings, slots) => {
  let senderAddress;
  let clientAddress;
  let items;
  let id;
  ...
  (0, import_index_d2589f30.o)(() => {
    (0, import_index_d2589f30.d)(import_functionStore_31d719cc.g, $globalStore.modalStatus = null, $globalStore);
    newInvoice = null;
  });
  let isValid = false;
  let prompt = null;
  ...
  let newInvoice = {
    ...
    clientName: "",
    clientEmail: "",
    paymentDue: (0, import_functionStore_31d719cc.c)(new Date(), terms),
    createdAt: (0, import_functionStore_31d719cc.c)(new Date(), 0),
    status: "",
    terms: +terms,
    description: "",
    total: 0,
    ...
    discardInvoice() {
      prompt = null;
      (0, import_functionStore_31d719cc.a)();
    },
    calculateTotal() {
      let total = 0;
      items.forEach((item) => {
    ...
    saveInvoice(status) {
      ...
      if ($globalStore.modalStatus === "edit") {
        ...
        invoice.paymentDue = (0, import_functionStore_31d719cc.c)(new Date(), terms);
        ...
        (0, import_index_d2589f30.d)(import_functionStore_31d719cc.g, $globalStore.invoices = [...$globalStore.invoices], $globalStore);
        localStorage.setItem("invoices", JSON.stringify($globalStore.invoices));
        (0, import_functionStore_31d719cc.a)();
        location.reload();
      } else {
        this.calculateTotal();
        (0, import_index_d2589f30.d)(import_functionStore_31d719cc.g, $globalStore.invoices = [...$globalStore.invoices, newInvoice], $globalStore);
        localStorage.setItem("invoices", JSON.stringify($globalStore.invoices));
        (0, import_functionStore_31d719cc.a)();
      }
    },
  ...
  do {
    ...
    {
      if ((0, import_functionStore_31d719cc.s)(senderAddress.street) && (0, import_functionStore_31d719cc.s)(senderAddress.city) && (0, import_functionStore_31d719cc.s)(senderAddress.country) && (0, import_functionStore_31d719cc.s)(senderAddress.postCode) && (0, import_functionStore_31d719cc.s)(clientAddress.street) && (0, import_functionStore_31d719cc.s)(clientAddress.city) && (0, import_functionStore_31d719cc.s)(clientAddress.country) && (0, import_functionStore_31d719cc.s)(clientAddress.postCode) && (0, import_functionStore_31d719cc.s)(newInvoice.clientName) && (0, import_functionStore_31d719cc.e)(newInvoice.clientEmail) && (0, import_functionStore_31d719cc.s)(newInvoice.description) && items.length > 0 && items.every((item) => (0, import_functionStore_31d719cc.s)(item.name)) && items.every((item) => item.quantity > 0) && items.every((item) => item.price > 0)) {
        isValid = true;
      } else {
        isValid = false;
      }
    }
    $$rendered = `<div class="${"modal svelte-zxxez"}">${(0, import_index_d2589f30.v)(import_functionStore_31d719cc.C, "Card").$$render($$result, { modal: true }, {}, {
      default: () => {
        return `<form class="${"svelte-zxxez"}"><div class="${"title svelte-zxxez"}">${(0, import_index_d2589f30.v)(import_functionStore_31d719cc.T, "Text").$$render($$result, {
          title: true,
          size: "h2",
          text: $globalStore.modalStatus === "add" ? "Add New Invoice" : `Edit Invoice #${id}`
        }, {}, {})}

                ${(0, import_index_d2589f30.v)(import_stores_7cb77692.B, "BackButton").$$render($$result, {}, {}, {})}</div>

            <div class="${"billFrom svelte-zxxez"}"><p class="${"svelte-zxxez"}">Bill From</p>
                <div class="${"billFrom_information svelte-zxxez"}">${(0, import_index_d2589f30.v)(import_InvoiceOptions_4b5fe3d5.F, "FormField").$$render($$result, {
          title: true,
          text: "Street Address",
          id: "senderStreet",
          placeholder: "Street Address",
          valid: (0, import_functionStore_31d719cc.s)(senderAddress.street),
          ...
          value: ($$value) => {
            ...
            $$settled = false;
                    ...
                    <div class="${"billFrom_information-city svelte-zxxez"}">${(0, import_index_d2589f30.v)(import_InvoiceOptions_4b5fe3d5.F, "FormField").$$render($$result, {
          title: true,
          text: "City",
          id: "senderCity",
          placeholder: "City",
          valid: (0, import_functionStore_31d719cc.s)(senderAddress.city),
          ...
          value: ($$value) => {
            ...
            $$settled = false;
                        ...
                        ${(0, import_index_d2589f30.v)(import_InvoiceOptions_4b5fe3d5.F, "FormField").$$render($$result, {
          title: true,
          text: "Postal Code",
          id: "senderPostCode",
          placeholder: "Postal code",
          valid: (0, import_functionStore_31d719cc.s)(senderAddress.postCode),
          ...
          value: ($$value) => {
            ...
            $$settled = false;
                        ...
                        <div class="${"billFrom_information-country svelte-zxxez"}">${(0, import_index_d2589f30.v)(import_InvoiceOptions_4b5fe3d5.F, "FormField").$$render($$result, {
          title: true,
          id: "senderCountry",
          text: "Country",
          placeholder: "Country",
          valid: (0, import_functionStore_31d719cc.s)(senderAddress.country),
          ...
          id: "clientName",
          placeholder: "Name",
          valid: (0, import_functionStore_31d719cc.s)(clientName),
          ...
          id: "clientEmail",
          placeholder: "Email",
          valid: (0, import_functionStore_31d719cc.e)(clientEmail),
          ...
          id: "clientStreet",
          placeholder: "Street Address",
          valid: (0, import_functionStore_31d719cc.s)(clientAddress.street),
          ...
          value: ($$value) => {
            ...
            $$settled = false;
                ...
                <div class="${"billTo_information svelte-zxxez"}"><div class="${"billTo_information-city svelte-zxxez"}">${(0, import_index_d2589f30.v)(import_InvoiceOptions_4b5fe3d5.F, "FormField").$$render($$result, {
          text: "City",
          id: "clientCity",
          placeholder: "City",
          valid: (0, import_functionStore_31d719cc.s)(clientAddress.city),
          invalidMessage: "Please enter a valid City",
          ...
          id: "clientPostCode",
          placeholder: "Postal code",
          valid: (0, import_functionStore_31d719cc.s)(clientAddress.postCode),
          ...
          value: ($$value) => {
            ...
            $$settled = false;
                        ...
                        <div class="${"billTo_information-country svelte-zxxez"}">${(0, import_index_d2589f30.v)(import_InvoiceOptions_4b5fe3d5.F, "FormField").$$render($$result, {
          id: "clientCountry",
          text: "Country",
          placeholder: "Country",
          valid: (0, import_functionStore_31d719cc.s)(clientAddress.country),
          invalidMessage: "Please enter a valid Country",
          ...
          value: ($$value) => {
            ...
            $$settled = false;
                ...
                <div class="${"billTo_invoiceInformation svelte-zxxez"}">${(0, import_index_d2589f30.v)(import_InvoiceOptions_4b5fe3d5.F, "FormField").$$render($$result, {
          text: "Payment Due",
          id: "paymentDue",
          disabled: true,
          value: (0, import_functionStore_31d719cc.c)(new Date(), terms),
          valid: true
        }, {}, {})}
          ...
          form: "select",
          text: "Payment Terms",
          options: import_InvoiceOptions_4b5fe3d5.o,
          id: "paymentTerms",
          value: terms
        }, {
          value: ($$value) => {
          ...
          valid: (0, import_functionStore_31d719cc.s)(description),
          ...
          value: ($$value) => {
            ...
            <div class="${"items svelte-zxxez"}">${(0, import_index_d2589f30.f)(items, (item, i) => {
          return `<div class="${"itemList svelte-zxxez"}"><div class="${"nameField svelte-zxxez"}">${(0, import_index_d2589f30.v)(import_InvoiceOptions_4b5fe3d5.F, "FormField").$$render($$result, {
            title: true,
            id: "Name" + i,
            text: "Name",
            placeholder: "Item",
            valid: (0, import_functionStore_31d719cc.s)(item.name),
            ...
            value: ($$value) => {
              ...
              $$settled = false;
                        ...
                        <div class="${"attributes svelte-zxxez"}">${(0, import_index_d2589f30.v)(import_InvoiceOptions_4b5fe3d5.F, "FormField").$$render($$result, {
            title: true,
            id: "qty" + i,
            form: "number",
            text: "Qty",
            ...
            value: ($$value) => {
              ...
              $$settled = false;
                            ...
                            ${(0, import_index_d2589f30.v)(import_InvoiceOptions_4b5fe3d5.F, "FormField").$$render($$result, {
            title: true,
            value: "$" + (0, import_functionStore_31d719cc.n)(item.quantity * item.price),
            valid: true,
            id: "total" + i,
            disabled: true,
            text: "Total",
          ...
          text: "Add Item"
            ...
            <div class="${"btns svelte-zxxez"}">${(0, import_index_d2589f30.v)(import_functionStore_31d719cc.B, "Button").$$render($$result, {
          type: "danger",
          icon: "trash",
          size: "medium",
          rounded: true,
          text: "Discard"
                ...
                <div class="${"svelte-zxxez"}">${(0, import_index_d2589f30.v)(import_functionStore_31d719cc.B, "Button").$$render($$result, {
          type: "secondary",
          icon: "save",
          size: "medium",
          disabled: !isValid,
...
${prompt == "discard" ? `${(0, import_index_d2589f30.v)(ModalPrompt, "ModalPrompt").$$render($$result, { text: "You want to discard the changes?" }, {}, {})}` : ``}

${prompt === "draft" ? `${(0, import_index_d2589f30.v)(ModalPrompt, "ModalPrompt").$$render($$result, {
      text: "You want to save this invoice as draft?"
    }, {}, {})}` : ``}

${prompt === "pending" ? `${(0, import_index_d2589f30.v)(ModalPrompt, "ModalPrompt").$$render($$result, {
...
const _layout = (0, import_index_d2589f30.c)(($$result, $$props, $$bindings, slots) => {
  let theme;
  let $globalStore, $$unsubscribe_globalStore;
  $$unsubscribe_globalStore = (0, import_index_d2589f30.a)(import_functionStore_31d719cc.g, (value) => $globalStore = value);
  $$result.css.add(css);
  ...
  $$unsubscribe_globalStore();
  return `${$globalStore.modalStatus !== null ? `${(0, import_index_d2589f30.v)(InvoiceModal, "InvoiceModal").$$render($$result, {}, {}, {})}` : ``}


${(0, import_index_d2589f30.v)(Navigation, "Navigation").$$render($$result, {}, {}, {})}
<main class="${"bgColor" + (0, import_index_d2589f30.e)(theme) + " svelte-1vdlmt2"}">${slots.default ? slots.default({}) : ``}</main>`;
});
