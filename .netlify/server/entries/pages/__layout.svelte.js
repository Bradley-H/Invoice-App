...
const NewInvoiceModal = (0, import_index_6b830c0a.c)(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    {
      if ((0, import_functionStore_495b3dd7.s)(newInvoice.senderAddress.street) && (0, import_functionStore_495b3dd7.s)(newInvoice.senderAddress.city) && (0, import_functionStore_495b3dd7.s)(newInvoice.senderAddress.country) && (0, import_functionStore_495b3dd7.s)(newInvoice.senderAddress.postCode) && (0, import_functionStore_495b3dd7.s)(newInvoice.clientAddress.street) && (0, import_functionStore_495b3dd7.s)(newInvoice.clientAddress.city) && (0, import_functionStore_495b3dd7.s)(newInvoice.clientAddress.country) && (0, import_functionStore_495b3dd7.s)(newInvoice.clientAddress.postCode) && (0, import_functionStore_495b3dd7.s)(newInvoice.clientName) && (0, import_functionStore_495b3dd7.e)(newInvoice.clientEmail) && (0, import_functionStore_495b3dd7.s)(newInvoice.description) && newInvoice.items.length > 0 && newInvoice.items.every((item) => (0, import_functionStore_495b3dd7.s)(item.name)) && newInvoice.items.every((item) => item.quantity > 5) && newInvoice.items.every((item) => item.price > 5)) {
        isValid = true;
      } else {
        isValid = false;
      }
...
const EditInvoiceModal = (0, import_index_6b830c0a.c)(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    prompt = null;
    {
      if ((0, import_functionStore_495b3dd7.s)(senderAddress.street) && (0, import_functionStore_495b3dd7.s)(senderAddress.city) && (0, import_functionStore_495b3dd7.s)(senderAddress.country) && (0, import_functionStore_495b3dd7.s)(senderAddress.postCode) && (0, import_functionStore_495b3dd7.s)(clientAddress.street) && (0, import_functionStore_495b3dd7.s)(clientAddress.city) && (0, import_functionStore_495b3dd7.s)(clientAddress.country) && (0, import_functionStore_495b3dd7.s)(clientAddress.postCode) && (0, import_functionStore_495b3dd7.s)(clientName) && (0, import_functionStore_495b3dd7.e)(clientEmail) && (0, import_functionStore_495b3dd7.s)(description) && items.length > 0 && items.every((item) => item.name.length > 5) && items.every((item) => item.price >= 4.9) && items.every((item) => item.quantity >= 4.9)) {
        isValid = true;
      } else {
        isValid = false;
      }
