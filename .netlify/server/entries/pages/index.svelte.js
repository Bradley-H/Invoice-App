...
var import_Button_5afc206d = __toModule(require("../../chunks/Button-5afc206d.js"));
...
const Invoice = (0, import_index_6b830c0a.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.C, "Card").$$render($$result, { inv: true, id }, {}, {
    default: () => `<div class="${"container-invoice svelte-1qgxoo4"}"><div class="${"dueInformation svelte-1qgxoo4"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "h3", text: "#" + id }, {}, {})}
            <div class="${"svelte-1qgxoo4"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, {
      size: "p",
      text: "Due: " + (0, import_functionStore_aea32d8f.c)(paymentDue, 0)
    }, {}, {})}
                ${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, {
      size: "h3",
      text: "$" + (0, import_functionStore_aea32d8f.n)(total.toFixed(2))
    }, {}, {})}</div></div>
    <div class="${"paymentInformation svelte-1qgxoo4"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "p", text: clientName }, {}, {})}
        ${(0, import_index_6b830c0a.v)(import_Tag_0004dd66.T, "Tag").$$render($$result, { status }, {}, {})}</div></div>`
  })}`;
});
var index_svelte_svelte_type_style_lang = "";
const css = {
  code: ".container.svelte-rtqu2o.svelte-rtqu2o{display:flex;flex-direction:column;width:100%;max-width:62.5rem}@media(min-width: 1200px){.container.svelte-rtqu2o.svelte-rtqu2o{display:grid;grid-template-columns:1fr;max-width:75rem}}.container.svelte-rtqu2o div.invoices.svelte-rtqu2o{display:flex;flex-direction:column;width:100%;max-width:62.5rem;margin-top:1.5rem}@media(min-width: 992px) and (max-width: 1199px){.container.svelte-rtqu2o div.invoices.svelte-rtqu2o{display:grid;place-items:center}}@media(min-width: 1200px){.container.svelte-rtqu2o div.invoices.svelte-rtqu2o{display:grid;grid-template-columns:1fr 1fr;gap:7px;justify-self:center;max-width:75rem}}.container.svelte-rtqu2o .helperBar.svelte-rtqu2o{display:flex;justify-content:space-between}.container.svelte-rtqu2o .helperBar_invoice.svelte-rtqu2o{display:flex;flex-direction:column;justify-content:center;margin-right:1rem}.container.svelte-rtqu2o .helperBar .settings.svelte-rtqu2o{display:grid;grid-template-columns:1fr 1fr;gap:10px}@media(min-width: 768px){.container.svelte-rtqu2o .helperBar .settings.svelte-rtqu2o{place-items:initial}}.container.svelte-rtqu2o .loading.svelte-rtqu2o{display:flex;justify-content:center;align-items:center;min-height:100vh;max-height:100%}.noInvoices.svelte-rtqu2o.svelte-rtqu2o{display:flex;justify-content:center;align-items:center;flex-direction:column;min-height:50vh}.noInvoices.svelte-rtqu2o div.svelte-rtqu2o{text-align:center;margin-top:1rem}",
  map: null
};
const Routes = (0, import_index_6b830c0a.c)(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="${"container svelte-rtqu2o"}">${function(__value) {
      if ((0, import_index_6b830c0a.j)(__value)) {
        __value.then(null, import_index_6b830c0a.n);
        return `
    <div class="${"loading svelte-rtqu2o"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, {
          size: "h3",
    ...
    `;
      ...
      return function() {
        return ` 
    <div class="${"helperBar svelte-rtqu2o"}"><div class="${"helperBar_invoice svelte-rtqu2o"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, { size: "h2", text: "Invoices" }, {}, {})}
            ${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, {
          size: "p",
          text: filteredInvoices.length + " invoices"
        }, {}, {})}</div>
        <div class="${"settings svelte-rtqu2o"}">${(0, import_index_6b830c0a.v)(import_Button_5afc206d.F, "FormField").$$render($$result, {
          id: "filter",
          form: "select",
          options,
          value: filter
          ...
          value: ($$value) => {
            ...
            ${(0, import_index_6b830c0a.v)(import_Button_5afc206d.B, "Button").$$render($$result, {
          rounded: true,
          icon: "plus",
          text: "Add Invoice"
        }, {}, {})}</div></div>
    ${$globalStore.invoices.length > 0 ? `<div class="${"invoices svelte-rtqu2o"}">${(0, import_index_6b830c0a.d)(filteredInvoices, ({ id, paymentDue, total, clientName, status }, i) => `${(0, import_index_6b830c0a.v)(Invoice, "Invoice").$$render($$result, {
          id,
          paymentDue,
          total,
          clientName,
          status
        }, {}, {})}`)}</div>` : `<div class="${"noInvoices svelte-rtqu2o"}"><img src="${"./noinvoice.svg"}" alt="${"No invoice"}">
            <div class="${"svelte-rtqu2o"}">${(0, import_index_6b830c0a.v)(import_functionStore_aea32d8f.T, "Text").$$render($$result, {
          title: true,
          size: "h2",
          text: "No Invoices"
        }, {}, {})}
    ...
    }((0, import_functionStore_aea32d8f.a)())}</div>`;
  } while (!$$settled);
