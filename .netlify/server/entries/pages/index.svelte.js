...
const Invoice = (0, import_index_6b830c0a.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.C, "Card").$$render($$result, { inv: true, id }, {}, {
    default: () => `<div class="${"container-invoice svelte-1qgxoo4"}"><div class="${"dueInformation svelte-1qgxoo4"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "h3", text: "#" + id }, {}, {})}
            <div class="${"svelte-1qgxoo4"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, {
      size: "p",
      text: "Due: " + (0, import_functionStore_495b3dd7.c)(paymentDue, 0)
    }, {}, {})}
                ${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, {
      size: "h3",
      text: "$" + (0, import_functionStore_495b3dd7.n)(total.toFixed(2))
    }, {}, {})}</div></div>
    <div class="${"paymentInformation svelte-1qgxoo4"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "p", text: clientName }, {}, {})}
        ${(0, import_index_6b830c0a.v)(import_Tag_e0cee0bc.T, "Tag").$$render($$result, { status }, {}, {})}</div></div>`
  })}`;
});
  ...
  do {
    ...
    $$rendered = `<div class="${"container svelte-8qukzm"}">${function(__value) {
      if ((0, import_index_6b830c0a.j)(__value)) {
        ...
        return `
    <div class="${"loading svelte-8qukzm"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, {
          size: "h3",
    ...
    `;
      ...
      return function() {
        return ` 
    <div class="${"helperBar svelte-8qukzm"}"><div class="${"helperBar_invoice svelte-8qukzm"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, { size: "h2", text: "Invoices" }, {}, {})}
            ${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, {
          size: "p",
          text: filteredInvoices.length + " invoices"
        }, {}, {})}</div>
        <div class="${"settings svelte-8qukzm"}">${(0, import_index_6b830c0a.v)(import_Button_f1a09eb8.F, "FormField").$$render($$result, {
          id: "filter",
          form: "select",
          options,
          value: filter
    ...
    ${$globalStore.invoices.length > 0 ? `<div class="${"invoices svelte-8qukzm"}">${(0, import_index_6b830c0a.d)(filteredInvoices, ({ id, paymentDue, total, clientName, status }, i) => `${(0, import_index_6b830c0a.v)(Invoice, "Invoice").$$render($$result, {
          ...
          status
            ...
            <div class="${"svelte-8qukzm"}">${(0, import_index_6b830c0a.v)(import_functionStore_495b3dd7.T, "Text").$$render($$result, {
          title: true,
          size: "h2",
          text: "No Invoices"
        }, {}, {})}
    ...
    }((0, import_functionStore_495b3dd7.a)())}</div>`;
  } while (!$$settled);
