...
const Invoice = (0, import_index_e78bd06d.c)(($$result, $$props, $$bindings, slots) => {
  let { id = "" } = $$props;
  ...
  return `${(0, import_index_e78bd06d.v)(import_functionStore_1bfb3d3a.C, "Card").$$render($$result, { inv: true, id }, {}, {
    default: () => {
      return `<div class="${"container-invoice svelte-1s6sk94"}"><div class="${"dueInformation svelte-1s6sk94"}">${(0, import_index_e78bd06d.v)(import_functionStore_1bfb3d3a.T, "Text").$$render($$result, { size: "h3", text: "#" + id }, {}, {})}
            <div class="${"svelte-1s6sk94"}">${(0, import_index_e78bd06d.v)(import_functionStore_1bfb3d3a.T, "Text").$$render($$result, {
        size: "p",
        text: "Due: " + (0, import_functionStore_1bfb3d3a.c)(paymentDue, 0)
      }, {}, {})}
                ${(0, import_index_e78bd06d.v)(import_functionStore_1bfb3d3a.T, "Text").$$render($$result, {
        size: "h3",
        text: "$" + (0, import_functionStore_1bfb3d3a.n)(total.toFixed(2))
      }, {}, {})}</div></div>
    <div class="${"paymentInformation svelte-1s6sk94"}">${(0, import_index_e78bd06d.v)(import_functionStore_1bfb3d3a.T, "Text").$$render($$result, { size: "p", text: clientName }, {}, {})}
        ${(0, import_index_e78bd06d.v)(import_Tag_29e959ce.T, "Tag").$$render($$result, { status }, {}, {})}</div></div>`;
    }
  })}`;
});
...
const Routes = (0, import_index_e78bd06d.c)(($$result, $$props, $$bindings, slots) => {
  let filter;
  ...
  do {
    ...
    $$rendered = `<div class="${"container svelte-1h70dj0"}">${function(__value) {
      if ((0, import_index_e78bd06d.l)(__value)) {
        ...
        return `
    <div class="${"loading svelte-1h70dj0"}">${(0, import_index_e78bd06d.v)(import_functionStore_1bfb3d3a.T, "Text").$$render($$result, {
          size: "h3",
    ...
    `;
      ...
      return function() {
        return ` 
    <div class="${"helperBar svelte-1h70dj0"}"><div class="${"helperBar_invoice svelte-1h70dj0"}">${(0, import_index_e78bd06d.v)(import_functionStore_1bfb3d3a.T, "Text").$$render($$result, { size: "h2", text: "Invoices" }, {}, {})}
            ${(0, import_index_e78bd06d.v)(import_functionStore_1bfb3d3a.T, "Text").$$render($$result, {
          size: "p",
          text: filteredInvoices.length + " invoices"
        }, {}, {})}</div>
        <div class="${"settings svelte-1h70dj0"}">${(0, import_index_e78bd06d.v)(import_InvoiceOptions_cf37dce2.F, "FormField").$$render($$result, {
          id: "filter",
          form: "select",
          options: import_InvoiceOptions_cf37dce2.a,
          value: filter
        }, {
          value: ($$value) => {
            filter = $$value;
    ...
    ${$globalStore.invoices.length > 0 ? `<div class="${"invoices svelte-1h70dj0"}">${(0, import_index_e78bd06d.f)(filteredInvoices, ({ id, paymentDue, total, clientName, status }, i) => {
          return `${(0, import_index_e78bd06d.v)(Invoice, "Invoice").$$render($$result, {
            id,
            paymentDue,
            total,
            clientName,
            ...
            <div class="${"svelte-1h70dj0"}">${(0, import_index_e78bd06d.v)(import_functionStore_1bfb3d3a.T, "Text").$$render($$result, {
          title: true,
          size: "h2",
          text: "No Invoices"
        }, {}, {})}
    ...
    }((0, import_functionStore_1bfb3d3a.b)())}</div>`;
  } while (!$$settled);
