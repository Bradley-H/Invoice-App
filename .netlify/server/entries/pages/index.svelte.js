...
const Invoice = (0, import_index_905b6237.c)(($$result, $$props, $$bindings, slots) => {
  let { id } = $$props;
  ...
  return `${(0, import_index_905b6237.v)(import_Button_svelte_svelte_type_style_lang_13fe77f7.C, "Card").$$render($$result, { inv: true, id }, {}, {
    default: () => `<div class="${"container-invoice svelte-1qgxoo4"}"><div class="${"dueInformation svelte-1qgxoo4"}">${(0, import_index_905b6237.v)(import_Button_svelte_svelte_type_style_lang_13fe77f7.T, "Text").$$render($$result, { size: "h3", text: "#" + id }, {}, {})}
            <div class="${"svelte-1qgxoo4"}">${(0, import_index_905b6237.v)(import_Button_svelte_svelte_type_style_lang_13fe77f7.T, "Text").$$render($$result, {
      size: "p",
      text: "Due: " + (0, import_Button_svelte_svelte_type_style_lang_13fe77f7.f)(paymentDue)
    }, {}, {})}
                ${(0, import_index_905b6237.v)(import_Button_svelte_svelte_type_style_lang_13fe77f7.T, "Text").$$render($$result, {
      size: "h3",
      text: "$" + (0, import_Button_svelte_svelte_type_style_lang_13fe77f7.a)(total.toFixed(2))
    }, {}, {})}</div></div>
    <div class="${"paymentInformation svelte-1qgxoo4"}">${(0, import_index_905b6237.v)(import_Button_svelte_svelte_type_style_lang_13fe77f7.T, "Text").$$render($$result, { size: "p", text: clientName }, {}, {})}
        ${(0, import_index_905b6237.v)(import_Tag_399a1d08.T, "Tag").$$render($$result, { status }, {}, {})}</div></div>`
  })}`;
});
...
const Routes = (0, import_index_905b6237.c)(($$result, $$props, $$bindings, slots) => {
  let filter;
  ...
  async function getInvoices() {
    ...
    (0, import_index_905b6237.j)(import_Button_svelte_svelte_type_style_lang_13fe77f7.g, $globalStore.invoices = data, $globalStore);
    localStorage.getItem("invoices") ? (0, import_index_905b6237.j)(import_Button_svelte_svelte_type_style_lang_13fe77f7.g, $globalStore.invoices = JSON.parse(localStorage.getItem("invoices")), $globalStore) : null;
  }
  $$result.css.add(css);
  let $$settled;
  let $$rendered;
  do {
    ...
    $$rendered = `<div class="${"container svelte-4nkv9z"}">${function(__value) {
      if ((0, import_index_905b6237.i)(__value)) {
        ...
        return `
    <div class="${"loading svelte-4nkv9z"}">${(0, import_index_905b6237.v)(import_Button_svelte_svelte_type_style_lang_13fe77f7.T, "Text").$$render($$result, {
          size: "h1",
    ...
    `;
      ...
      return function() {
        return ` 
    <div class="${"helperBar svelte-4nkv9z"}"><div class="${"helperBar_invoice svelte-4nkv9z"}">${(0, import_index_905b6237.v)(import_Button_svelte_svelte_type_style_lang_13fe77f7.T, "Text").$$render($$result, { size: "h2", text: "Invoices" }, {}, {})}
            ${(0, import_index_905b6237.v)(import_Button_svelte_svelte_type_style_lang_13fe77f7.T, "Text").$$render($$result, {
          size: "p",
          text: filteredInvoices.length + " invoices"
        }, {}, {})}</div>
        <div class="${"settings svelte-4nkv9z"}">${(0, import_index_905b6237.v)(import_Button_e9b3d195.F, "FormField").$$render($$result, {
          id: "filter",
          form: "select",
          options,
          text: "",
    ...
    <div class="${"invoices svelte-4nkv9z"}">${(0, import_index_905b6237.d)(filteredInvoices, ({ id, paymentDue, total, clientName, status }, i) => `${(0, import_index_905b6237.v)(Invoice, "Invoice").$$render($$result, {
          id,
          paymentDue,
          total,
          clientName,
